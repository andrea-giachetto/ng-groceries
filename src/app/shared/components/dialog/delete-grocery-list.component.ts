...
@Component({
  selector: 'app-delete-grocery-list-dialog',
  template: `
    ...
    <mat-dialog-content class="mat-typography">
      <p>You are deleting a grocery list, this operation can't be undone.</p>
...
export class DeleteGroceryListDialogComponent {

  constructor(
    public dialogRef: MatDialogRef<DeleteGroceryListDialogComponent>,
  ) { }
